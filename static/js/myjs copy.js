      ...
      dataType: 'json',
		    ...
		    overlay.draw = function() {
	            ...
	            google.maps.event.addListener(markerCluster, "clusterclick", function (m) { 
		            ...
		            var compoundedData = "<strong> Patent | Inventor | Assignee | LAT | LON | AppYear | Grant Year | State | City | Country</strong><br>";
		            var output = ""
			      ...
			      function transform(d) {
					...
					var mark = new google.maps.Marker({
			            ...
			            + ", " + d.value[5] + ", " + d.value[6] + ", " + d.value[7] + ", " + d.value[8] + ", " + d.value[9],
			            //clickable: true,
			        ...
			        google.maps.event.addListener(mark, "click", function (e) {
		            	...
		            	infoWindow = new google.maps.InfoWindow();
		            	out = mark.getTitle()
		            	outp = "<span> Patent | Inventor | Asssignee</span><br>" + out
	            ...
	            google.maps.event.addListener(markerCluster, "clusterclick", function (m) { 
			      ...
			      function transform(d) {
			        ...
			        google.maps.event.addListener(mark, "click", function (e) {
		            	...
		            	infoWindow = new google.maps.InfoWindow();
		            	out = mark.getTitle()
		            	outp = "<strong> Patent | Inventor | Assignee | LAT | LON | AppYear | Grant Year | State | City | Country</strong><br>" + out
		                infoWindow.setContent(outp);
		                $("#expo").attr("href", "data:text/plain;base64," + btoa(out) )
						$("#expo").attr("download", "export.txt")
						$("#expo").html("Export Patent infomation of this location.")
